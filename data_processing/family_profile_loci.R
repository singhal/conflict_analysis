...
dir = '/scratch/drabosky_flux/sosi/SqCL_July2017/family_phylogeny/rooted_300_0.05_0.3/'
...
write.csv(res, "/scratch/drabosky_flux/sosi/SqCL_July2017/family_phylogeny/loci_profiling2.csv", row.names=F)
